...
const SongCard: React.FC<SongCardProps> = ({ song, index, onPlay, currentSong }) => {
  ...
  return (
    ...
    >
      <div className="relative mb-3 sm:mb-4">
        ...
        <div
          className={`
    absolute bottom-2 right-2 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-button shadow-custom-lg 
  ...
  `}
        >
          {currentSong && currentSong._id === song._id ? (
            // Show equalizer animation if it's the current song
            <div className="flex items-end gap-[3px] w-4 h-5">
            ...
            // Show Play icon on hover if it's not the current song
